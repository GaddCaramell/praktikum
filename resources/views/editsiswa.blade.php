            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-10">
                            <input type="number" class="form-control" name="nisn" value="{{$siswadata->nisn}}" disabled>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="" class="col-form-label col-2">Nama</label>
                        <div class="col-10">
                            <input type="text" class="form-control" name="nama" value="{{$siswadata->nama}}">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="" class="col-form-label col-2">Alamat</label>
                        <div class="col-10">
                            <input type="text" class="form-control" name="alamat" value="{{$siswadata->alamat}}">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="" class="col-form-label col-2">No Hp</label>
                        <div class="col-10">
                            <input type="text" class="form-control" name="no_telp" value="{{$siswadata->no_telp}}">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="" class="col-form-label col-2">Kelas</label>
                        <div class="col-10">
                            <input type="text" class="form-control" name="kode_kelas" value="{{$siswadata->kode_kelas}}">
                        </div>
                    </div>
                    <div class="mb-3">
